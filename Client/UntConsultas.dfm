object frmConsultas: TfrmConsultas
  ...
  object cxPCPrincipal: TcxPageControl
    ...
    Align = alClient
    TabOrder = 1
    Properties.ActivePage = cxtsCaixa
    ...
    object cxtsCaixa: TcxTabSheet
      ...
      object cxDBPivotGrid1: TcxDBPivotGrid
        ...
        Height = 233
        Align = alTop
        DataSource = DM.dsgraficoCaixa
        Groups = <>
        LookAndFeel.NativeStyle = False
        TabOrder = 0
        object cxDBPivotGrid1ID_PEDIDO: TcxDBPivotGridField
          AreaIndex = 0
          IsCaptionAssigned = True
          Caption = 'N'#186' Pedido'
          DataBinding.FieldName = 'ID_PEDIDO'
          Visible = True
          UniqueName = 'N'#186' Pedido'
        end
        object cxDBPivotGrid1DATA_PEDIDO: TcxDBPivotGridField
          AreaIndex = 1
          IsCaptionAssigned = True
          Caption = 'Data do Pedido'
          DataBinding.FieldName = 'DATA_PEDIDO'
          Visible = True
          UniqueName = 'Data do Pedido'
        end
        object cxDBPivotGrid1DESCRICAO_FORMA_DE_PAGAMENTO: TcxDBPivotGridField
          AreaIndex = 2
          IsCaptionAssigned = True
          Caption = 'Forma de Pagamento'
          DataBinding.FieldName = 'DESCRICAO_FORMA_DE_PAGAMENTO'
          Visible = True
          UniqueName = 'Forma de Pagamento'
        end
        object cxDBPivotGrid1CONDICAO_DE_PAGAMENTO: TcxDBPivotGridField
          AreaIndex = 3
          IsCaptionAssigned = True
          Caption = 'Condi'#231#227'o de Pagamento'
          DataBinding.FieldName = 'CONDICAO_DE_PAGAMENTO'
          Visible = True
          UniqueName = 'Condi'#231#227'o de Pagamento'
        end
        object cxDBPivotGrid1VALOR: TcxDBPivotGridField
          AreaIndex = 4
          IsCaptionAssigned = True
          Caption = 'Valor'
      ...
      object cxGRDGrafico: TcxGrid
        ...
        TabOrder = 1
        LookAndFeel.NativeStyle = False
        object cxGRDGraficoChartView1: TcxGridChartView
          DiagramColumn.Active = True
        end
        object cxGRDGraficoLevel1: TcxGridLevel
          GridView = cxGRDGraficoChartView1
        end
      end
    end
  end
  object cxPivotGridChartConnection1: TcxPivotGridChartConnection
    GridChartView = cxGRDGraficoChartView1
