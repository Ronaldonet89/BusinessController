    ...
    object cxtsPrincipal: TcxTabSheet
      ...
      object DBComboBox1: TDBComboBox
        ...
        Items.Strings = (
          ...
          'A'#231'o Trefilado'
          'adesivo'
          'Ag'#234'ncia de Emprego'
          #193'gua'
          'Arame'
          'Assist.T'#233'cnica'
          'Borracha'
          'Cabo de A'#231'o'
          'Caixa de Papel'#227'o'
          'Cantoneira'
          'Cartucho'
          'Coleta'
          'Coleta de Lixo'
          ...
          'P'#243' de Ferro'
          'Reloginho'
          'Rel'#243'gio de Ponto'
          'Repuxo'
          'Rolamento'
          'Serra'
          'Servi'#231'o de Internet'
          'Servi'#231'os'
          'Tecido'
          'Telefonia'
          'T'#234'mpera'
  ...
  object Panel1: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        object cxGrid1DBTableView1TIPO_FORNECEDOR: TcxGridDBColumn
          Caption = 'Tipo fornecedor'
          DataBinding.FieldName = 'TIPO_FORNECEDOR'
        end
