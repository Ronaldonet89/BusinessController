object frmPdv: TfrmPdv
  ...
  object spbCapturarPedido: TSpeedButton
    Left = 928
    Top = 540
    Width = 102
    Height = 22
    Caption = 'Capturar Pedido'
    Visible = False
    OnClick = spbCapturarPedidoClick
  end
  ...
  object Panel3: TPanel
    ...
    object Label3: TLabel
      ...
      Align = alBottom
      Caption = 
        'F1 = Ini. venda / F2 = Cancel. Item / F3 = Capturar Ped. / F4 = ' +
        'Consultar Pre'#231'o / F9 = Cancel. Venda / F10 = Confirm. Venda '
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Segoe UI'
    ...
    object edtQuantidade: TEdit
      ...
      OnKeyDown = edtQuantidadineKeyDown
